...
\cventry
{Kore Labs} % Job title
{Lead ML Engineer} % Organization
{London - U.K.} % Location
{2024 - Present} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item {Creating Agents to automatize the data governance of financial ontologies. LLMOps for an extended prompt database.}
\item {RAG-graph systems with Langgraph and PGvector deployed on GCP. Using OpenAI Assistants to guide end users of DB products.}
\end{cvitems}
}
