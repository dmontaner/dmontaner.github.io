...
\cventry
{Kore Labs} % Job title
{Lead ML/AI Engineer} % Organization
{London - U.K.} % Location
{2024 - Present} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item {Created Agents that automatize the governance of financial taxonomies and ontologies. Knowledge Graphs and scoring systems.}
\item {RAG-graph systems with Langgraph and PGvector, deployed on GCP. Converted REST APIs into MCP servers for agentic access.}
\end{cvitems}
}
...
\cventry
{Publicis Sapient - consulting for \textbf{Deutsche Bank}} % Job title
...
\item {Deploying RAG systems on the Google Cloud Platform (GCP). Using OpenAI Assistants and Google PaLM 2 models to guide end users.}
\end{cvitems}
}
